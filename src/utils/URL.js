/**
 * URL工具类
 * Created by aaron on 17/7/6.
 * link  https://github.com/LittoCats/react-native-url
 */
...
export default class URL {
  ...
  set query (query) {
    this.__s.query = query
    this.__s.queryParam = parseQueryString(query)
  }
...
function parse (url) {
  ...
  proto.queryParam = parseQueryString(proto.query)
